...
export default function Hero({ dark }) {
  ...
  className="w-full sm:w-auto font-sans font-semibold text-sm px-6 py-3.5 rounded-xl cursor-pointer bg-btn-primary text-btn-primary flex items-center justify-center gap-2 transition-all hover:-translate-y-0.5 hover:shadow-lg"
>
